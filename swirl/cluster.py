...
##
##
##  This it the implementation of the Clustering by fast 
##  search and find of density peaks (CFSFDP) algorithm
##  used to cluster the EVCs and find vortices and the
##  cells belonging to them. 
##  It contains:
##    - findcluster2D
##    - compute_rho 
##    - compute_delta 
...
##
##
def findcluster2D(data, dc_coeff, dc_adaptive, dl, fast_clustering, xi_option, clust_selector, clust_options):
#
#******************** 
# This routine uses a modified CFSFDP algorithm to cluster
# the 2D EVC points and classify them into clusters and noise.
# For each cluster, a central point is provided, which will
# be used as center of the vortex by the main algorithm.
#******************** 
# 
##  INPUTS
...
#     - Option: to use the approximate to grid coordinates of EVC
#       to boost the clustering algorithm
#  - xi_option : int
...
#  - clust_options : list
#     - list of parameters for clust_selector option
#
##  OUTPUTS:
#   
#   - cluster_id : array
...
#   - d : 2D array
#     - Matrix containing all distances between "rotating" points 
#
###############################################

...
#
  ...
  # 
  #********************
  # Plot rho-delta and gamma diagrams 
  #********************
  ##  INPUTS
  #    
  ##  OUTPUTS
  ...
  ###############
    ...
    # Selector params
    rho_opt = self.clust_options[1]
    delta_opt = self.clust_options[0]
    gamma_opt = self.clust_options[2]
